...
const AsignaturaTab = ({ idAsig, codigo, nombre, reviews }) => {
  return (
    <Link
      href={`/cursos/${idAsig}`}
      className='bg-white cursor-pointer rounded-xl border-dashed border-2 hover:border-solid hover:border-4 border-chinese-blue w-full min-h-[94px] h-fit flex p-4'
    >
